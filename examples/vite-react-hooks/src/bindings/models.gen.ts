...
import { CairoCustomEnum, CairoOption, CairoOptionVariant, BigNumberish, Uint256 } from 'starknet';
...
export const schema: SchemaType = {
  [NAMESPACE]: {
    ...
    TokenMetadata: {
      fieldOrder: ['token_id', 'minted_by', 'player_name', 'settings_id', 'lifecycle'],
      token_id: 0,
      minted_by: '',
      player_name: 0,
      settings_id: 0,
    ...
    Prize: {
      fieldOrder: ['id', 'tournament_id', 'payout_position', 'token_address', 'token_type'],
      id: 0,
      tournament_id: 0,
      payout_position: 0,
      token_address: '',
    ...
    PrizeValue: {
      fieldOrder: ['tournament_id', 'payout_position', 'token_address', 'token_type'],
      tournament_id: 0,
      payout_position: 0,
      token_address: '',
      token_type: new CairoCustomEnum({
    ...
    Registration: {
      fieldOrder: ['tournament_id', 'game_token_id', 'entry_number', 'has_submitted'],
      tournament_id: 0,
      game_token_id: 0,
      entry_number: 0,
      has_submitted: false,
