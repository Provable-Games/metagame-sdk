import { Chain, mainnet, sepolia, NativeCurrency } from '@starknet-react/chains';
...
const slotKatanaConfig: DojoChainConfig = {
  chain: undefined, // derive from this
  chainId: ChainId.WP_GAME_COMPONENTS,
  name: 'PG Slot',
  rpcUrl: 'https://api.cartridge.gg/x/game-components/katana',
  toriiUrl: 'https://api.cartridge.gg/x/game-components/torii',
  toriiTokensUrl: '',
  relayUrl: undefined,
  blastRpc: undefined,
  blockExplorerUrl: undefined,
...
const snSepoliaConfig: DojoChainConfig = {
  ...
  toriiUrl: 'https://api.cartridge.gg/x/pg-sepolia-5/torii',
  toriiTokensUrl: '',
  relayUrl: undefined,
  blastRpc: undefined,
...
export const CHAINS: Record<ChainId, DojoChainConfig> = {
  ...
  [ChainId.WP_GAME_COMPONENTS]: makeDojoChainConfig(slotKatanaConfig),
